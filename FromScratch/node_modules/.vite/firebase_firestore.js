...
// node_modules/@firebase/firestore/dist/esm5/prebuilt-ac190846-5fb4dac2.js
/**
 * @license
...
function N2(t2) {
  ...
  if (S2.logLevel <= LogLevel.DEBUG) {
    var r2 = e.map(x2);
    S2.debug.apply(S2, __spreadArray(["Firestore (8.4.0): " + t2], r2));
  }
}
function A2(t2) {
  for (var e = [], n2 = 1; n2 < arguments.length; n2++)
  ...
  if (S2.logLevel <= LogLevel.ERROR) {
    var r2 = e.map(x2);
    S2.error.apply(S2, __spreadArray(["Firestore (8.4.0): " + t2], r2));
  }
}
function k2(t2) {
  for (var e = [], n2 = 1; n2 < arguments.length; n2++)
  ...
  if (S2.logLevel <= LogLevel.WARN) {
    var r2 = e.map(x2);
    S2.warn.apply(S2, __spreadArray(["Firestore (8.4.0): " + t2], r2));
  }
}
function x2(t2) {
  if (typeof t2 == "string")
...
function C(t2) {
  ...
  var e = "FIRESTORE (8.4.0) INTERNAL ASSERTION FAILED: " + t2;
...
var G2 = function() {
  function t2(t3, e, n2) {
    e === void 0 ? e = 0 : e > t3.length && C(), n2 === void 0 ? n2 = t3.length - e : n2 > t3.length - e && C(), this.segments = t3, this.offset = e, this.len = n2;
  }
...
var st = function() {
  ...
  return t2.fromPath = function(e) {
    ...
    return t3 !== null && Q2.comparator(this.path, t3.path) === 0;
  }, t2.prototype.toString = function() {
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (B(n3) !== B(r2))
          return false;
        for (var i in n3)
          if (n3.hasOwnProperty(i) && (r2[i] === void 0 || !at(n3[i], r2[i])))
            return false;
        return true;
      }(t2, e);
    default:
  ...
  switch (n2) {
    ...
    case 8:
      return function(t3, e2) {
        ...
        return n3 !== 0 ? n3 : M2(J2(t3.longitude), J2(e2.longitude));
...
function ft(t2, e) {
  ...
  return i !== 0 ? i : M2(n2.nanos, r2.nanos);
}
function lt(t2) {
  return dt(t2);
}
...
var bt = function() {
  function t2(t3) {
    this.overlayMap = new Map(), this.partialValue = t3;
  }
  return t2.empty = function() {
    ...
    for (var n2 = this.overlayMap, r2 = 0; r2 < t3.length - 1; ++r2) {
      ...
      o instanceof Map ? n2 = o : o && ut(o) === 10 ? (o = new Map(Object.entries(o.mapValue.fields || {})), n2.set(i, o), n2 = o) : (o = new Map(), n2.set(i, o), n2 = o);
    }
    n2.set(t3.lastSegment(), e);
  }, t2.prototype.applyOverlay = function(e, n2) {
    var r2 = this, i = false, o = t2.extractNestedValue(this.partialValue, e), s = wt(o) ? Object.assign({}, o.mapValue.fields) : {};
    return n2.forEach(function(t3, n3) {
      if (t3 instanceof Map) {
        var o2 = r2.applyOverlay(e.child(n3), t3);
        o2 != null && (s[n3] = o2, i = true);
      } else
        t3 !== null ? (s[n3] = t3, i = true) : s.hasOwnProperty(n3) && (delete s[n3], i = true);
    }), i ? {
      mapValue: {
        fields: s
      }
    ...
    return t3 != null && (this.partialValue = t3, this.overlayMap.clear()), this.partialValue;
...
function Tt(t2, e, n2, r2, i, o, s) {
  return e === void 0 && (e = null), n2 === void 0 && (n2 = []), r2 === void 0 && (r2 = []), i === void 0 && (i = null), o === void 0 && (o = null), s === void 0 && (s = null), new Et(t2, e, n2, r2, i, o, s);
}
function St(t2) {
  var e = O2(t2);
  if (e.h === null) {
...
var At = function(t2) {
  ...
  return __extends(e, t2), e.create = function(t3, n2, r2) {
    return t3.isKeyField() ? n2 === "in" || n2 === "not-in" ? this.l(t3, n2, r2) : new kt(t3, n2, r2) : n2 === "array-contains" ? new Ot(t3, r2) : n2 === "in" ? new Lt(t3, r2) : n2 === "not-in" ? new Pt(t3, r2) : n2 === "array-contains-any" ? new Mt(t3, r2) : new e(t3, n2, r2);
  }, e.l = function(t3, e2, n2) {
    return e2 === "in" ? new xt(t3, n2) : new Ct(t3, n2);
  }, e.prototype.matches = function(t3) {
    var e2 = t3.data.field(this.field);
    return this.op === "!=" ? e2 !== null && this.m(ht(e2, this.value)) : e2 !== null && ut(this.value) === ut(e2) && this.m(ht(e2, this.value));
...
var Lt = function(t2) {
  ...
  return __extends(e, t2), e.prototype.matches = function(t3) {
    var e2 = t3.data.field(this.field);
    return e2 !== null && ct(this.value.arrayValue, e2);
  }, e;
}(At);
var Pt = function(t2) {
  function e(e2, n2) {
...
function Bt(t2, e, n2) {
  for (var r2 = 0, i = 0; i < t2.position.length; i++) {
    ...
    if (r2 = o.field.isKeyField() ? st.comparator(st.fromName(s.referenceValue), n2.key) : ht(s, n2.data.field(o.field)), o.dir === "desc" && (r2 *= -1), r2 !== 0)
      break;
  }
 ...
 * limitations under the License.
 */
var Kt = function(t2, e, n2, r2, i, o, s, u) {
...
function zt(t2) {
  return !rt(t2.limit) && t2.limitType === "F";
}
function Wt(t2) {
  return !rt(t2.limit) && t2.limitType === "L";
}
function Ht(t2) {
...
function $t(t2) {
  ...
  if (e.p === null) {
    ...
    var n2 = Yt(e), r2 = Ht(e);
    if (n2 !== null && r2 === null)
      n2.isKeyField() || e.p.push(new qt(n2)), e.p.push(new qt(W2.keyField(), "asc"));
    else {
...
function re(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    var n2 = e2.key.path;
    return t3.collectionGroup !== null ? e2.key.hasCollectionId(t3.collectionGroup) && t3.path.isPrefixOf(n2) : st.isDocumentKey(t3.path) ? t3.path.isEqual(n2) : t3.path.isImmediateParentOf(n2);
  }(t2, e) && function(t3, e2) {
...
function oe(t2, e, n2) {
  var r2 = t2.field.isKeyField() ? st.comparator(e.key, n2.key) : function(t3, e2, n3) {
    ...
    return r3 !== null && i !== null ? ht(r3, i) : C();
  }(t2.field, e, n2);
  switch (t2.dir) {
    case "asc":
      return r2;
...
function Ne(t2, e, n2) {
  t2 instanceof Ce ? function(t3, e2, n3) {
    ...
    Te(t3.precondition, e2) && e2.convertToNoDocument(U2.min());
  }(t2, e);
}
function Ae(t2, e) {
  for (var n2 = null, r2 = 0, i = t2.fieldTransforms; r2 < i.length; r2++) {
    var o = i[r2], s = e.data.field(o.field), u = le(o.transform, s || null);
    u != null && (n2 == null && (n2 = bt.empty()), n2.set(o.field, u));
  }
  return n2 || null;
}
function ke(t2, e) {
  return t2.type === e.type && !!t2.key.isEqual(e.key) && !!t2.precondition.isEqual(e.precondition) && !!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && F2(t3, e2, function(t4, e3) {
...
Qe.EMPTY = null, Qe.RED = true, Qe.BLACK = false, Qe.EMPTY = new (function() {
  function t2() {
    this.size = 0;
  }
...
var hn = function() {
  function t2() {
    this.S = 0, this.D = dn(), this.C = Y2.EMPTY_BYTE_STRING, this.N = false, this.F = true;
  }
...
var fn = function() {
  function t2(t3) {
    this.W = t3, this.G = new Map(), this.H = Ye(), this.J = ln(), this.Y = new ze(M2);
  }
    ...
    this.forEachTarget(t3, function(n2) {
      ...
      switch (t3.state) {
        case 0:
          ...
          break;
        case 1:
          r2.K(), r2.k || r2.L(), r2.$(t3.resumeToken);
          break;
        case 2:
        ...
        case 3:
          ...
          break;
        case 4:
          e.st(n2) && (e.it(n2), r2.$(t3.resumeToken));
          break;
        default:
          C();
      }
    ...
    this.G.forEach(function(r3, i2) {
      ...
      if (o) {
        if (r3.current && Nt(o.target)) {
          ...
          e.H.get(s) !== null || e.at(i2, s) || e.tt(i2, s, _t.newNoDocument(s, t3));
        }
...
function Rn(t2, e) {
  var n2 = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? Ee.updateTime(bn(t3.updateTime)) : t3.exists !== void 0 ? Ee.exists(t3.exists) : Ee.none();
  }(e.currentDocument) : Ee.none(), r2 = e.updateTransforms ? e.updateTransforms.map(function(e2) {
    return function(t3, e3) {
      var n3 = null;
      if ("setToServerValue" in e3)
        R2(e3.setToServerValue === "REQUEST_TIME"), n3 = new de();
...
function Ln(t2, e) {
  ...
  e.collectionGroup !== null ? (n2.parent = Sn(t2, r2), n2.structuredQuery.from = [{
  ...
  return s !== null && (n2.structuredQuery.limit = s), e.startAt && (n2.structuredQuery.startAt = Fn(e.startAt)), e.endAt && (n2.structuredQuery.endAt = Fn(e.endAt)), n2;
}
function Pn(t2) {
  ...
  n2.orderBy && (u = n2.orderBy.map(function(t3) {
    return function(t4) {
      return new qt(jn(t4.field), function(t5) {
        switch (t5) {
          case "ASCENDING":
            return "asc";
          case "DESCENDING":
  ...
  n2.limit && (a = function(t3) {
    var e2;
    return rt(e2 = typeof t3 == "object" ? t3.value : t3) ? null : e2;
  }(n2.limit));
  var c = null;
...
function Mn(t2) {
  return t2 ? t2.unaryFilter !== void 0 ? [Gn(t2)] : t2.fieldFilter !== void 0 ? [Kn(t2)] : t2.compositeFilter !== void 0 ? t2.compositeFilter.filters.map(function(t3) {
    return Mn(t3);
...
tr.store = "mutations", tr.keyPath = "batchId", tr.userMutationsIndex = "userMutationsIndex", tr.userMutationsKeyPath = ["userId", "batchId"];
var er = function() {
  function t2() {
  }
...
er.store = "documentMutations", er.PLACEHOLDER = new er();
...
var ir = function(t2, e, n2, r2, i, o) {
...
ir.store = "remoteDocuments", ir.readTimeIndex = "readTimeIndex", ir.readTimeIndexPath = "readTime", ir.collectionReadTimeIndex = "collectionReadTimeIndex", ir.collectionReadTimeIndexPath = ["parentPath", "readTime"];
var or = function(t2) {
  this.byteSize = t2;
};
...
sr.store = "targets", sr.keyPath = "targetId", sr.queryTargetsIndexName = "queryTargetsIndex", sr.queryTargetsKeyPath = ["canonicalId", "targetId"];
var ur = function(t2, e, n2) {
  this.targetId = t2, this.path = e, this.sequenceNumber = n2;
};
ur.store = "targetDocuments", ur.keyPath = ["targetId", "path"], ur.documentTargetsIndex = "documentTargetsIndex", ur.documentTargetsKeyPath = ["path", "targetId"];
...
var gr = function() {
  function t2(t3, e) {
    var n2 = this;
    this.action = t3, this.transaction = e, this.aborted = false, this.ft = new vr(), this.transaction.oncomplete = function() {
      n2.ft.resolve();
...
var wr = function() {
  function e(n2, r2, i) {
    this.name = n2, this.version = r2, this.wt = i, e._t(getUA()) === 12.2 && A2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
            ...
            i = e2 === "readonly", o = 0, s = function() {
              ...
              return __generator(this, function(f) {
                switch (f.label) {
                  ...
                  case 4:
                    return c2 = f.sent(), h2 = c2.name !== "FirebaseError" && o < 3, N2("SimpleDb", "Transaction failed with error:", c2.message, "Retrying:", h2), u.close(), h2 ? [3, 5] : [2, {
...
var Er = function() {
  ...
  return t2.prototype.put = function(t3, e) {
    var n2;
    return e !== void 0 ? (N2("SimpleDb", "PUT", this.store.name, t3, e), n2 = this.store.put(e, t3)) : (N2("SimpleDb", "PUT", this.store.name, "<auto-key>", t3), n2 = this.store.put(t3)), Tr(n2);
  }, t2.prototype.add = function(t3) {
...
function Dr(e) {
  ...
  if (n2 >= 12.2 && n2 < 13) {
    ...
    if (e.message.indexOf(r2) >= 0) {
      ...
      return Sr || (Sr = true, setTimeout(function() {
        throw i;
      }, 0)), i;
    }
  }
...
var Cr = function() {
  function t2(t3, e, n2, r2, i, o, s) {
    i === void 0 && (i = U2.min()), o === void 0 && (o = U2.min()), s === void 0 && (s = Y2.EMPTY_BYTE_STRING), this.target = t3, this.targetId = e, this.purpose = n2, this.sequenceNumber = r2, this.snapshotVersion = i, this.lastLimboFreeSnapshotVersion = o, this.resumeToken = s;
  }
...
function Lr(t2, e, n2) {
  ...
  if (e.isFoundDocument()) {
    ...
    return new ir(null, null, o, s, r2, i);
  }
  if (e.isNoDocument()) {
    var u = e.key.path.toArray(), a = Fr(e.version);
    s = e.hasCommittedMutations;
    return new ir(null, new nr(u, a), null, s, r2, i);
  }
  if (e.isUnknownDocument()) {
    var c = e.key.path.toArray(), h2 = Fr(e.version);
    return new ir(new rr(c, h2), null, null, true, r2, i);
  }
  return C();
}
function Pr(t2) {
...
function Ur(t2) {
  var e, n2, r2 = Vr(t2.readTime), i = t2.lastLimboFreeSnapshotVersion !== void 0 ? Vr(t2.lastLimboFreeSnapshotVersion) : U2.min();
  return t2.query.documents !== void 0 ? (R2((n2 = t2.query).documents.length === 1), e = Jt(Qt(Dn(n2.documents[0])))) : e = function(t3) {
    return Jt(Pn(t3));
...
function jr(t2) {
  ...
  return t2.limitType === "LAST" ? Zt(e, e.limit, "L") : e;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var Hr = function() {
  ...
  return t2.prototype.addToCollectionParentIndex = function(t3, e) {
    ...
    var n2 = [], r2 = IDBKeyRange.bound([e, ""], [V2(e), ""], false, true);
...
var si = function() {
  ...
  return t2.prototype.allocateTargetId = function(t3) {
    ...
    var n2 = ci(t3), r2 = IDBKeyRange.bound([e], [e + 1], false, true);
    return n2.delete(r2);
  }, t2.prototype.getMatchingKeysForTargetId = function(t3, e) {
    var n2 = IDBKeyRange.bound([e], [e + 1], false, true), r2 = ci(t3), i = en();
    return r2.Ot({
      range: n2,
      kt: true
    }, function(t4, e2, n3) {
    ...
    var n2 = Wn(e.path), r2 = IDBKeyRange.bound([n2], [V2(n2)], false, true), i = 0;
    return ci(t3).Ot({
...
var pi = function() {
  ...
  return t2.prototype.calculateTargetCount = function(t3, e) {
    ...
    var n2 = this;
    return this.params.cacheSizeCollectionThreshold === -1 ? (N2("LruGarbageCollector", "Garbage collection skipped; disabled"), mr.resolve(Xr)) : this.getCacheSize(t3).next(function(r2) {
...
var yi = function() {
  ...
  return t2.prototype.he = function(t3) {
    ...
    return r2.Ot({
      ...
      o === 0 ? (i !== _.o && e(new st(Xn(n2)), i), i = u, n2 = s) : i = _.o;
    }).next(function() {
...
function vi(t2, e) {
  return ci(t2).put(function(t3, e2) {
...
var gi = function() {
  ...
  return t2.prototype.getReadTime = function(t3) {
    ...
    return n2 !== void 0 ? mr.resolve(n2.document) : this.getFromCache(t3, e);
...
var wi = function() {
  ...
  return t2.prototype.addEntry = function(t3, e, n2) {
    ...
    if (n2.isEqual(U2.min())) {
      ...
      s.range = IDBKeyRange.lowerBound([a, c], true), s.index = ir.collectionReadTimeIndex;
    }
...
var bi = function(t2) {
  function e(e2, n2) {
    var r2 = this;
    return (r2 = t2.call(this) || this).Ie = e2, r2.trackRemovals = n2, r2.Ae = new mi(function(t3) {
      return t3.toString();
    }, function(t3, e3) {
...
var Ti = function() {
  ...
  return t2.prototype.Rt = function(t3, e, n2, r2) {
    ...
    return n2 < 3 && r2 >= 3 && (n2 !== 0 && (function(t4) {
      ...
      return function(t4) {
        var e2 = t4.store(ar.store), n3 = new ar(0, 0, U2.min().toTimestamp(), 0);
...
var Ni = function() {
  function t2(e, n2, r2, i, o, s, u, a, c, h2) {
    if (this.allowTabSynchronization = e, this.persistenceKey = n2, this.clientId = r2, this.Se = o, this.window = s, this.document = u, this.De = c, this.Ce = h2, this.Ne = null, this.xe = false, this.isPrimary = false, this.networkEnabled = true, this.Fe = null, this.inForeground = false, this.ke = null, this.Oe = null, this.$e = Number.NEGATIVE_INFINITY, this.Me = function(t3) {
    ...
    this.referenceDelegate = new yi(this, i), this.Le = n2 + "main", this.R = new Rr(a), this.Be = new wr(this.Le, 11, new Ti(this.R)), this.qe = new si(this.referenceDelegate, this.R), this.Ut = new Hr(), this.Ue = function(t3, e2) {
      return new wi(t3, e2);
    }(this.R, this.Ut), this.Qe = new Kr(), this.window && this.window.localStorage ? this.Ke = this.window.localStorage : (this.Ke = null, h2 === false && A2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  return t2.prototype.start = function() {
    ...
    return this.Be.runTransaction(t3, o, dr, function(o2) {
      return i = new Nr(o2, r2.Ne ? r2.Ne.next() : _.o), e === "readwrite-primary" ? r2.Je(i).next(function(t4) {
        return !!t4 || r2.Ye(i);
      }).next(function(e2) {
        if (!e2)
...
var Ri = function() {
  ...
  return t2.prototype.mn = function(t3, e) {
    ...
    return function(t4) {
      return st.isDocumentKey(t4.path) && t4.collectionGroup === null && t4.filters.length === 0;
    ...
    return this.Ut.getCollectionParents(t3, i).next(function(s) {
      return mr.forEach(s, function(s2) {
        var u = function(t4, e2) {
          return new Kt(e2, null, t4.explicitOrderBy.slice(), t4.filters.slice(), t4.limit, t4.limitType, t4.startAt, t4.endAt);
        }(e, s2.child(i));
      ...
      return i = e2, o.Rn(t3, i, r2).next(function(t4) {
        ...
        for (var e3 = 0, n3 = i; e3 < n3.length; e3++)
          for (var o2 = n3[e3], s = 0, u = o2.mutations; s < u.length; s++) {
            ...
            h2 == null && (h2 = _t.newInvalidDocument(c), r2 = r2.insert(c, h2)), Ne(a, h2, o2.localWriteTime), h2.isFoundDocument() || (r2 = r2.remove(c));
          }
      });
    }).next(function() {
    ...
    for (var r2 = en(), i = 0, o = e; i < o.length; i++)
      for (var s = 0, u = o[i].mutations; s < u.length; s++) {
        var a = u[s];
        a instanceof Re && n2.get(a.key) === null && (r2 = r2.add(a.key));
      }
    var c = n2;
...
var Pi = function() {
  function t2(t3, e, n2, r2) {
    this.persistence = t3, this.xn = e, this.R = r2, this.Fn = new Ke(M2), this.kn = new mi(function(t4) {
      return St(t4);
    }, Dt), this.On = U2.min(), this._n = t3.getMutationQueue(n2), this.$n = t3.getRemoteDocumentCache(), this.qe = t3.getTargetCache(), this.Mn = new Ri(this.$n, this._n, this.persistence.getIndexManager()), this.Qe = t3.getBundleCache(), this.xn.Vn(this.Mn);
  }
        ...
        case 0:
          return n2 = O2(t2), r2 = n2._n, i = n2.Mn, [4, n2.persistence.runTransaction("Handle user change", "readonly", function(t3) {
            ...
            return n2._n.getAllMutationBatches(t3).next(function(s2) {
              return o2 = s2, r2 = n2.persistence.getMutationQueue(e), i = new Ri(n2.$n, r2, n2.persistence.getIndexManager()), r2.getAllMutationBatches(t3);
            }).next(function(e2) {
    ...
    return function(t4, e2, n3, r3) {
      ...
      return o.forEach(function(t5) {
        s = s.next(function() {
          ...
          R2(o2 !== null), e3.version.compareTo(o2) < 0 && (i2.applyToRemoteDocument(e3, n3), e3.isValidDocument() && r3.addEntry(e3, n3.commitVersion));
        });
      }), s.next(function() {
      ...
      if (u2) {
        ...
        if (a2.approximateByteSize() > 0) {
          ...
          i = i.insert(o2, c), function(t4, e3, n3) {
            return R2(e3.resumeToken.approximateByteSize() > 0), t4.resumeToken.approximateByteSize() === 0 || (e3.snapshotVersion.toMicroseconds() - t4.snapshotVersion.toMicroseconds() >= 3e8 || n3.addedDocuments.size + n3.modifiedDocuments.size + n3.removedDocuments.size > 0);
...
function Bi(t2, e, n2, r2, i) {
  ...
  return n2.forEach(function(t3) {
    ...
    return n2.forEach(function(n3, s) {
      ...
      s.isNoDocument() && s.version.isEqual(U2.min()) ? (e.removeEntry(n3, a), o2 = o2.insert(n3, s)) : !u.isValidDocument() || s.version.compareTo(u.version) > 0 || s.version.compareTo(u.version) === 0 && u.hasPendingWrites ? (e.addEntry(s, a), o2 = o2.insert(n3, s)) : N2("LocalStore", "Ignoring outdated watch update for ", n3, ". Current version:", u.version, " Watch version:", s.version);
    }), o2;
  });
}
function ji(t2, e) {
...
function Ki(t2, e) {
  ...
  return n2.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return n2.qe.getTargetData(t3, e).next(function(i) {
      return i ? (r2 = i, mr.resolve(r2)) : n2.qe.allocateTargetId(t3).next(function(i2) {
...
function Qi(t2, e, n2) {
  ...
  return r2.persistence.runTransaction("Execute query", "readonly", function(t3) {
    return function(t4, e2, n3) {
      ...
      return i2 !== void 0 ? mr.resolve(r3.Fn.get(i2)) : r3.qe.getTargetData(e2, n3);
...
function Xi(t2, e, n2) {
  return n2 === void 0 && (n2 = en()), __awaiter(this, void 0, void 0, function() {
    var r2, i;
    return __generator(this, function(o) {
      switch (o.label) {
        case 0:
...
var Ji = function() {
  function t2() {
    this.Wn = new ze(Zi.Gn), this.zn = new ze(Zi.Hn);
  }
...
var to = function() {
  function t2(t3, e) {
    this.Ut = t3, this.referenceDelegate = e, this._n = [], this.ss = 1, this.rs = new ze(Zi.Gn);
  }
  return t2.prototype.checkEmpty = function(t3) {
    return mr.resolve(this._n.length === 0);
  }, t2.prototype.addMutationBatch = function(t3, e, n2, r2) {
    var i = this.ss;
    ...
    return mr.resolve(this._n.length === 0 ? -1 : this.ss - 1);
  }, t2.prototype.getAllMutationBatches = function(t3) {
    ...
    var n2 = this;
    R2(this.hs(e.batchId, "removed") === 0), this._n.shift();
    var r2 = this.rs;
...
var eo = function() {
  function t2(t3, e) {
    this.Ut = t3, this.ls = e, this.docs = new Ke(st.comparator), this.size = 0;
  }
  return t2.prototype.addEntry = function(t3, e, n2) {
...
var ro = function() {
  function t2(t3) {
    this.persistence = t3, this.ds = new mi(function(t4) {
      return St(t4);
    }, Dt), this.lastRemoteSnapshotVersion = U2.min(), this.highestTargetId = 0, this.ws = 0, this._s = new Ji(), this.targetCount = 0, this.ys = oi.Jt();
  }
  return t2.prototype.forEachTarget = function(t3, e) {
    ...
    return this.ds.forEach(function(s, u) {
      u.sequenceNumber <= e && n2.get(u.targetId) === null && (r2.ds.delete(s), o.push(r2.removeMatchingKeysForTargetId(t3, u.targetId)), i++);
...
var so = function() {
  function t2(t3) {
    this.persistence = t3, this.As = new Ji(), this.Rs = null;
  }
...
uo.UNAUTHENTICATED = new uo(null), uo.GOOGLE_CREDENTIALS = new uo("google-credentials-uid"), uo.FIRST_PARTY = new uo("first-party-uid");
var fo = function() {
  function t2(t3, e, n2, r2) {
  ...
  return t2.Vs = function(e, n2, r2) {
    ...
    return s && o.error && ((s = typeof o.error.message == "string" && typeof o.error.code == "string") && (i = new T2(o.error.code, o.error.message))), s ? new t2(e, n2, o.state, i) : (A2("SharedClientState", "Failed to parse mutation state for ID '" + n2 + "': " + r2), null);
...
var lo = function() {
  ...
  return t2.Vs = function(e, n2) {
    ...
    return o && i.error && ((o = typeof i.error.message == "string" && typeof i.error.code == "string") && (r2 = new T2(i.error.code, i.error.message))), o ? new t2(e, i.state, r2) : (A2("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n2), null);
  }, t2.prototype.Ss = function() {
    var t3 = {
      state: this.state,
      updateTimeMs: Date.now()
...
var po = function() {
  ...
  return t2.Vs = function(e, n2) {
    for (var r2 = JSON.parse(n2), i = typeof r2 == "object" && r2.activeTargetIds instanceof Array, o = rn(), s = 0; i && s < r2.activeTargetIds.length; ++s)
...
var mo = function() {
  function t2(t3, e, n2, r2, i) {
    this.window = t3, this.Se = e, this.persistenceKey = n2, this.Ns = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.xs = this.Fs.bind(this), this.ks = new Ke(M2), this.started = false, this.Os = [];
    var o = n2.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.$s = ao(this.persistenceKey, this.Ns), this.Ms = function(t4) {
      return "firestore_sequence_number_" + t4;
    }(this.persistenceKey), this.ks = this.ks.insert(this.Ns, new vo()), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), this.Bs = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.qs = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), this.Us = function(t4) {
  ...
  return t2.yt = function(t3) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(e) {
        return t3.user.uid === this.currentUser.uid ? [2, this.syncEngine.ui(t3.batchId, t3.state, t3.error)] : (N2("SharedClientState", "Ignoring mutation for non-active user " + t3.user.uid), [2]);
      });
    });
...
var Eo = function(t2) {
  ...
  return __extends(u, t2), u.prototype.ki = function(t3, e, n2, r2) {
    ...
    this.Fi(f.initMessageHeaders, u2), isMobileCordova() || isReactNative() || isElectron() || isIE() || isUWP() || isBrowserExtension() || (f.httpHeadersOverwriteParam = "$httpHeaders");
    var l = a.join("");
    N2("Connection", "Creating WebChannel: " + l, f);
    var g = c.createWebChannel(l, f), w2 = false, b = false, I3 = new _o({
      Ei: function(t4) {
    ...
    return _2(g, WebChannel.EventType.OPEN, function() {
      ...
      b || (b = true, N2("Connection", "WebChannel transport closed"), I3.Vi());
    }), _2(g, WebChannel.EventType.ERROR, function(t4) {
      b || (b = true, k2("Connection", "WebChannel transport errored:", t4), I3.Vi(new T2(E2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!b) {
        ...
        if (i) {
          ...
          s === void 0 && (s = E2.INTERNAL, u3 = "Unknown error status: " + o + " with message " + i.message), b = true, I3.Vi(new T2(s, u3)), g.close();
        } else
          N2("Connection", "WebChannel received:", n2), I3.Si(n2);
      }
  ...
  return t2.prototype.Ni = function(t3, e, n2, r2) {
    ...
    if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.4.0", t3["X-Firebase-GMPID"] = this.databaseInfo.appId, t3["Content-Type"] = "text/plain", e)
...
var Ao = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.Se = t3, this.zi = n2, this.Hi = r2, this.Ji = i, this.listener = o, this.state = 0, this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new No(t3, e);
  }
  return t2.prototype.tr = function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n2) {
        switch (n2.label) {
          case 0:
            return this.ur(), this.Zi.cancel(), this.Yi++, t3 !== 3 ? this.Zi.reset() : e && e.code === E2.RESOURCE_EXHAUSTED ? (A2(e.toString()), A2("Using maximum backoff delay to prevent overloading the backend."), this.Zi.Ki()) : e && e.code === E2.UNAUTHENTICATED && this.Ji.invalidateToken(), this.stream !== null && (this.ar(), this.stream.close(), this.stream = null), this.state = t3, [4, this.listener.Ri(e)];
          case 1:
            return n2.sent(), [2];
        }
      });
  ...
  return __extends(e, t2), e.prototype.wr = function(t3) {
    ...
    var e2 = function(t4, e3) {
      ...
      if ("targetChange" in e3) {
        e3.targetChange;
        var r2 = function(t5) {
          return t5 === "NO_CHANGE" ? 0 : t5 === "ADD" ? 1 : t5 === "REMOVE" ? 2 : t5 === "CURRENT" ? 3 : t5 === "RESET" ? 4 : C();
        }(e3.targetChange.targetChangeType || "NO_CHANGE"), i = e3.targetChange.targetIds || [], o = function(t5, e4) {
          return t5.I ? (R2(e4 === void 0 || typeof e4 == "string"), Y2.fromBase64String(e4 || "")) : (R2(e4 === void 0 || e4 instanceof Uint8Array), Y2.fromUint8Array(e4 || new Uint8Array()));
        }(t4, e3.targetChange.resumeToken), s = (u = e3.targetChange.cause) && function(t5) {
          var e4 = t5.code === void 0 ? E2.UNKNOWN : je(t5.code);
    ...
    e2.database = Nn(this.R), e2.addTarget = function(t4, e3) {
      ...
      return (n3 = Nt(r2) ? {
        ...
        query: Ln(t4, r2)
      }).targetId = e3.targetId, e3.resumeToken.approximateByteSize() > 0 ? n3.resumeToken = gn(t4, e3.resumeToken) : e3.snapshotVersion.compareTo(U2.min()) > 0 && (n3.readTime = mn(t4, e3.snapshotVersion.toTimestamp())), n3;
    }(this.R, t3);
...
var xo = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "pr", {
    ...
    if (R2(!!t3.streamToken), this.lastStreamToken = t3.streamToken, this.gr) {
      this.Zi.reset();
      var e2 = function(t4, e3) {
        return t4 && t4.length > 0 ? (R2(e3 !== void 0), t4.map(function(t5) {
          return function(t6, e4) {
            var n3 = t6.updateTime ? bn(t6.updateTime) : bn(e4);
            return n3.isEqual(U2.min()) && (n3 = bn(e4)), new _e(n3, t6.transformResults || []);
          }(t5, e3);
        })) : [];
      }(t3.writeResults, t3.commitTime), n2 = bn(t3.commitTime);
      return this.listener.Tr(n2, e2);
    }
    return R2(!t3.writeResults || t3.writeResults.length === 0), this.gr = true, this.listener.Ir();
  }, e.prototype.Ar = function() {
    var t3 = {};
...
var Oo = function(t2, e, n2, r2, i) {
  var o = this;
  this.localStore = t2, this.datastore = e, this.asyncQueue = n2, this.remoteSyncer = {}, this.kr = [], this.Or = new Map(), this.$r = new Set(), this.Mr = [], this.Lr = i, this.Lr.di(function(t3) {
              ...
              return jo(this) ? (N2("RemoteStore", "Restarting streams for network reachability change."), [4, function(t5) {
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(n3) {
                    switch (n3.label) {
                      case 0:
                        return (e2 = O2(t5)).$r.add(4), [4, Po(e2)];
                      case 1:
                        return n3.sent(), e2.Br.set("Unknown"), e2.$r.delete(4), [4, Lo(e2)];
                      case 2:
                        return n3.sent(), [2];
                    }
                  });
...
function Mo(t2, e) {
  var n2 = O2(t2);
  n2.Or.has(e.targetId) || (n2.Or.set(e.targetId, e), Bo(n2) ? Uo(n2) : rs(n2).er() && Vo(n2, e));
}
function Fo(t2, e) {
  var n2 = O2(t2), r2 = rs(n2);
  n2.Or.delete(e), r2.er() && qo(n2, e), n2.Or.size === 0 && (r2.er() ? r2.ir() : jo(n2) && n2.Br.set("Unknown"));
}
function Vo(t2, e) {
...
function Qo(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n2) {
      return Ko(t2), Bo(t2) ? (t2.Br.Nr(e), Uo(t2)) : t2.Br.set("Unknown"), [2];
    });
  });
}
function zo(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        case 0:
          if (t2.Br.set("Online"), !(e instanceof cn && e.state === 2 && e.cause))
            return [3, 6];
          s.label = 1;
        case 1:
          ...
          return i = s.sent(), n2.compareTo(i) >= 0 ? [
            ...
            function(t3, e2) {
              ...
              return n3.targetChanges.forEach(function(n4, r3) {
                ...
                var n4 = t3.Or.get(e3);
                if (n4) {
                  t3.Or.set(e3, n4.withResumeToken(Y2.EMPTY_BYTE_STRING, n4.snapshotVersion)), qo(t3, e3);
            ...
            return __awaiter(r2, void 0, void 0, function() {
              return __generator(this, function(e2) {
                switch (e2.label) {
                  ...
                  case 1:
                    return e2.sent(), t2.$r.delete(1), [4, Lo(t2)];
                  case 2:
                    return e2.sent(), [2];
                }
              });
          ...
          return e && is(t2).pr ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(i) {
                switch (i.label) {
                  case 0:
                    return Be(r2 = e2.code) && r2 !== E2.ABORTED ? (n3 = t3.kr.shift(), is(t3).sr(), [4, Ho(t3, function() {
...
function ns(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        case 0:
          return n2 = O2(t2), e ? (n2.$r.delete(2), [4, Lo(n2)]) : [3, 2];
        case 1:
          return i.sent(), [3, 5];
        case 2:
          return (r2 = e) ? [3, 4] : (n2.$r.add(2), [4, Po(n2)]);
        case 3:
  ...
  return t2.Ur || (t2.Ur = function(t3, e2, n2) {
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return n2 ? (t2.Ur.sr(), Bo(t2) ? Uo(t2) : t2.Br.set("Unknown"), [3, 3]) : [3, 1];
          case 1:
            return [4, t2.Ur.stop()];
          case 2:
...
var os = function() {
  function t2(t3, e, n2, r2, i) {
    this.asyncQueue = t3, this.timerId = e, this.targetTimeMs = n2, this.op = r2, this.removalCallback = i, this.deferred = new vr(), this.then = this.deferred.promise.then.bind(this.deferred.promise), this.deferred.promise.catch(function(t4) {
    });
  }
  return t2.createAndSchedule = function(e, n2, r2, i, o) {
    ...
    this.timerHandle !== null && (this.clearTimeout(), this.deferred.reject(new T2(E2.CANCELLED, "Operation cancelled" + (t3 ? ": " + t3 : ""))));
...
var cs = function() {
  ...
  return t2.fromInitialDocuments = function(e, n2, r2, i) {
    ...
    }), new t2(e, n2, us.emptySet(n2), o, r2, i, true, false);
  }, Object.defineProperty(t2.prototype, "hasPendingWrites", {
    get: function() {
...
var fs = function() {
  this.queries = new mi(function(t2) {
    return ee(t2);
  }, te), this.onlineState = "Unknown", this.Gr = new Set();
};
/**
 * @license
 * Copyright 2017 Google LLC
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        ...
        case 4:
          return n2.queries.set(r2, o), o.listeners.push(e), e.zr(n2.onlineState), o.Wr && e.Hr(o.Wr) && vs(n2), [2];
      }
    });
  });
}
function ds(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n2, r2, i, o, s;
    return __generator(this, function(u) {
      return n2 = O2(t2), r2 = e.query, i = false, (o = n2.queries.get(r2)) && (s = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(s, 1), i = o.listeners.length === 0), i ? [2, (n2.queries.delete(r2), n2.onUnlisten(r2))] : [2];
    });
  });
}
function ps(t2, e) {
...
var ms = function() {
  ...
  return t2.prototype.Hr = function(t3) {
    if (!this.options.includeMetadataChanges) {
      ...
      t3 = new cs(t3.query, t3.docs, t3.oldDocs, e, t3.mutatedKeys, t3.fromCache, t3.syncStateChanged, true);
    }
    var o = false;
...
var bs = function() {
  function t2(t3, e, n2) {
    this.ro = t3, this.localStore = e, this.R = n2, this.queries = [], this.documents = [], this.progress = Is(t3);
  }
  return t2.prototype.oo = function(t3) {
    ...
    for (var e = new Map(), n2 = new ws(this.R), r2 = 0, i = t3; r2 < i.length; r2++) {
      var o = i[r2];
...
var Ts = function() {
  function t2(t3, e) {
    this.query = t3, this.uo = e, this.ao = null, this.current = false, this.ho = en(), this.mutatedKeys = en(), this.lo = ie(t3), this.fo = new us(this.lo);
  }
  return Object.defineProperty(t2.prototype, "wo", {
    ...
    if (t3.inorderTraversal(function(t4, e2) {
      var h3 = i.get(t4), f = re(n2.query, e2) ? e2 : null, l = !!h3 && n2.mutatedKeys.has(h3.key), d = !!f && (f.hasLocalMutations || n2.mutatedKeys.has(f.key) && f.hasCommittedMutations), p2 = false;
      h3 && f ? h3.data.isEqual(f.data) ? l !== d && (r2.track({
        ...
        type: 2,
        doc: f
      }), p2 = true, (a && n2.lo(f, a) > 0 || c && n2.lo(f, c) < 0) && (u = true)) : !h3 && f ? (r2.track({
        type: 0,
        doc: f
    ...
    return this.ao = u, o.length !== 0 || a ? {
      snapshot: new cs(this.query, t3.fo, i, o, t3.mutatedKeys, u === 0, a, false),
      To: s
    } : {
      To: s
    };
    ...
    return cs.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, this.ao === 0);
  }, t2;
}();
...
var Ns = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.localStore = t3, this.remoteStore = e, this.eventManager = n2, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.vo = {}, this.Po = new mi(function(t4) {
      return ee(t4);
    }, te), this.Vo = new Map(), this.So = new Set(), this.Do = new Ke(st.comparator), this.Co = new Map(), this.No = new Ji(), this.xo = {}, this.Fo = new Map(), this.ko = oi.Yt(), this.onlineState = "Unknown", this.Oo = void 0;
  }
...
function As(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        case 0:
          return n2 = ru(t2), (o = n2.Po.get(e)) ? (r2 = o.targetId, n2.sharedClientState.addLocalQueryTarget(r2), i = o.view.Ro(), [3, 4]) : [3, 1];
        case 1:
          return [4, Ki(n2.localStore, Jt(e))];
        case 2:
          return s = a.sent(), u = n2.sharedClientState.addLocalQueryTarget(s.targetId), r2 = s.targetId, [4, ks(n2, e, r2, u === "current")];
        case 3:
            ...
            return function(t3, e3, n4, r4) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(u2) {
                  switch (u2.label) {
                    case 0:
                      return i2 = e3.view._o(n4), i2.Nn ? [4, Qi(t3.localStore, e3.query, false).then(function(t4) {
                        var n5 = t4.documents;
                    ...
                    case 2:
                      return o2 = r4 && r4.targetChanges.get(e3.targetId), s2 = e3.view.applyChanges(i2, t3.isPrimaryClient, o2), [2, (js(t3, e3.targetId, s2.To), s2.snapshot)];
                  }
                });
              });
            }(t2, e2, n3, r3);
          }, [4, Qi(t2.localStore, e, true)];
        case 1:
          return i = h2.sent(), o = new Ts(e, i.Bn), s = o._o(i.documents), u = sn.createSynthesizedTargetChangeForCurrentChange(n2, r2 && t2.onlineState !== "Offline"), a = o.applyChanges(s, t2.isPrimaryClient, u), js(t2, n2, a.To), c = new Ss(e, n2, o), [2, (t2.Po.set(e, c), t2.Vo.has(n2) ? t2.Vo.get(n2).push(e) : t2.Vo.set(n2, [e]), a.snapshot)];
      }
    });
  });
}
      ...
      switch (o.label) {
        case 0:
          return n2 = O2(t2), r2 = n2.Po.get(e), (i = n2.Vo.get(r2.targetId)).length > 1 ? [2, (n2.Vo.set(r2.targetId, i.filter(function(t3) {
            return !te(t3, e);
          })), void n2.Po.delete(e))] : n2.isPrimaryClient ? (n2.sharedClientState.removeLocalQueryTarget(r2.targetId), n2.sharedClientState.isActiveQueryTarget(r2.targetId) ? [3, 2] : [4, Gi(n2.localStore, r2.targetId, false).then(function() {
        ...
        case 2:
          return [3, 5];
        case 3:
          return Us(n2, r2.targetId), [4, Gi(n2.localStore, r2.targetId, true)];
        case 4:
          o.sent(), o.label = 5;
        case 5:
          return [2];
            ...
            return r3.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r3.Mn.pn(t4, o2).next(function(o3) {
                ...
                for (var s2 = [], u2 = 0, a = e2; u2 < a.length; u2++) {
                  ...
                  h2 != null && s2.push(new Re(c.key, h2, It(h2.toProto().mapValue), Ee.exists(true)));
                }
      ...
      switch (i.label) {
        ...
        case 2:
          return r2 = i.sent(), e.targetChanges.forEach(function(t3, e2) {
            var r3 = n2.Co.get(e2);
            r3 && (R2(t3.addedDocuments.size + t3.modifiedDocuments.size + t3.removedDocuments.size <= 1), t3.addedDocuments.size > 0 ? r3.bo = true : t3.modifiedDocuments.size > 0 ? R2(r3.bo) : t3.removedDocuments.size > 0 && (R2(r3.bo), r3.bo = false));
          }), [4, Qs(n2, r2, e)];
        case 3:
          return i.sent(), [3, 6];
        case 4:
...
function Ls(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        case 0:
          return (r2 = O2(t2)).sharedClientState.updateQueryState(e, "rejected", n2), i = r2.Co.get(e), (o = i && i.key) ? (s = (s = new Ke(st.comparator)).insert(o, _t.newNoDocument(o, U2.min())), u = en().add(o), a = new on(U2.min(), new Map(), new ze(M2), s, u), [4, Rs(r2, a)]) : [3, 2];
        case 1:
          return c.sent(), r2.Do = r2.Do.remove(o), r2.Co.delete(e), Gs(r2), [3, 4];
        case 2:
          return [4, Gi(r2.localStore, e, false).then(function() {
            return Us(r2, e, n2);
          }).catch(hi)];
        case 3:
          c.sent(), c.label = 4;
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o) {
      switch (o.label) {
        ...
        case 2:
          return i = o.sent(), qs(n2, r2, null), Vs(n2, r2), n2.sharedClientState.updateMutationState(r2, "acknowledged"), [4, Qs(n2, i)];
        case 3:
          return o.sent(), [3, 6];
        case 4:
          return [4, hi(o.sent())];
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o) {
      switch (o.label) {
          ...
          return o.trys.push([1, 4, , 6]), [4, function(t3, e2) {
            ...
            return n3.persistence.runTransaction("Reject batch", "readwrite-primary", function(t4) {
              ...
              return n3._n.lookupMutationBatch(t4, e2).next(function(e3) {
                return R2(e3 !== null), r3 = e3.keys(), n3._n.removeMutationBatch(t4, e3);
              }).next(function() {
        ...
        case 2:
          return i = o.sent(), qs(r2, e, n2), Vs(r2, e), r2.sharedClientState.updateMutationState(e, "rejected", n2), [4, Qs(r2, i)];
        case 3:
          return o.sent(), [3, 6];
        case 4:
          return [4, hi(o.sent())];
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        ...
        case 2:
          return (r2 = u.sent()) === -1 ? [2, void e.resolve()] : ((i = n2.Fo.get(r2) || []).push(e), n2.Fo.set(r2, i), [3, 4]);
        case 3:
...
function Us(t2, e, n2) {
  ...
  t2.Vo.delete(e), t2.isPrimaryClient && t2.No.Zn(e).forEach(function(e2) {
    t2.No.containsKey(e2) || Bs(t2, e2);
  });
}
function Bs(t2, e) {
  t2.So.delete(e.path.canonicalString());
  var n2 = t2.Do.get(e);
  n2 !== null && (Fo(t2.remoteStore, n2), t2.Do = t2.Do.remove(e), t2.Co.delete(n2), Gs(t2));
}
function js(t2, e, n2) {
  for (var r2 = 0, i = n2; r2 < i.length; r2++) {
    var o = i[r2];
    o instanceof _s ? (t2.No.addReference(o.key, e), Ks(t2, o)) : o instanceof Es ? (N2("SyncEngine", "Document no longer in limbo: " + o.key), t2.No.removeReference(o.key, e), t2.No.containsKey(o.key) || Bs(t2, o.key)) : C();
  }
}
function Ks(t2, e) {
                ...
                switch (f.label) {
                  ...
                  case 4:
                    for (i2 = 0, o2 = e2; i2 < o2.length; i2++)
                      s2 = o2[i2], u2 = s2.targetId, s2.fromCache || (a = n3.Fn.get(u2), c = a.snapshotVersion, h2 = a.withLastLimboFreeSnapshotVersion(c), n3.Fn = n3.Fn.insert(u2, h2));
                    return [2];
                }
              });
            });
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 1:
          ...
          }(n2), n2.sharedClientState.handleUserChange(e, r2.removedBatchIds, r2.addedBatchIds), [4, Qs(n2, r2.Ln)];
        case 2:
          i.sent(), i.label = 3;
        case 3:
          return [2];
...
function Hs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o) {
      switch (o.label) {
        case 0:
          return [4, Qi((n2 = O2(t2)).localStore, e.query, true)];
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        ...
        case 1:
          return (o = s.sent()) === null ? [3, 6] : n2 !== "pending" ? [3, 3] : [4, Yo(i.remoteStore)];
        case 2:
          return s.sent(), [3, 4];
        case 3:
          n2 === "acknowledged" || n2 === "rejected" ? (qs(i, e, r2 || null), Vs(i, e), function(t3, e2) {
            O2(O2(t3)._n).Gt(e2);
...
function $s(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(h2) {
      switch (h2.label) {
        case 0:
          return ru(n2 = O2(t2)), iu(n2), e !== true || n2.Oo === true ? [3, 3] : (r2 = n2.sharedClientState.getAllActiveQueryTargets(), [4, Js(n2, r2.toArray())]);
        case 1:
        ...
        case 2:
          ...
          return [3, 7];
        case 3:
          return e !== false || n2.Oo === false ? [3, 7] : (a = [], c = Promise.resolve(), n2.Vo.forEach(function(t3, e2) {
            n2.sharedClientState.isLocalQueryTarget(e2) ? a.push(e2) : c = c.then(function() {
              return Us(n2, e2), Gi(n2.localStore, e2, true);
        ...
        case 5:
          return h2.sent(), function(t3) {
            ...
            }), e2.No.ts(), e2.Co = new Map(), e2.Do = new Ke(st.comparator);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(v2) {
      switch (v2.label) {
        ...
        case 1:
          return o < s.length ? (u = s[o], a = void 0, (c = n3.Vo.get(u)) && c.length !== 0 ? [4, Ki(n3.localStore, Jt(c[0]))] : [3, 7]) : [3, 13];
        case 2:
        ...
        case 9:
          return a = v2.sent(), [4, ks(n3, Zs(y2), u, false)];
        case 10:
          v2.sent(), v2.label = 11;
        case 11:
...
function eu(t2, e, n2, r2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        case 0:
          return (i = O2(t2)).Oo ? (N2("SyncEngine", "Ignoring unexpected query state notification."), [3, 8]) : [3, 1];
        case 1:
          if (!i.Vo.has(e))
            return [3, 8];
          switch (n2) {
        ...
        case 3:
          return o = u.sent(), s = on.createSynthesizedRemoteEventForCurrentChange(e, n2 === "current"), [4, Qs(i, o, s)];
        case 4:
          return u.sent(), [3, 8];
        case 5:
          return [4, Gi(i.localStore, e, true)];
        case 6:
    ...
    return __generator(this, function(d) {
      switch (d.label) {
        case 0:
          ...
          i = 0, o = e, d.label = 1;
        case 1:
          return i < o.length ? (s = o[i], r2.Vo.has(s) ? (N2("SyncEngine", "Adding an already active target " + s), [3, 5]) : [4, zi(r2.localStore, s)]) : [3, 6];
        case 2:
          return u = d.sent(), [4, Ki(r2.localStore, u)];
        case 3:
          return a = d.sent(), [4, ks(r2, Zs(u), a.targetId, false)];
        case 4:
        ...
        case 6:
          c = function(t3) {
            return __generator(this, function(e2) {
              switch (e2.label) {
                case 0:
                  return r2.Vo.has(t3) ? [4, Gi(r2.localStore, t3, false).then(function() {
...
var uu = function(t2) {
  ...
  return __extends(e, t2), e.prototype.initialize = function(e2) {
    ...
    var e2 = xi(t3.databaseInfo.databaseId, t3.databaseInfo.persistenceKey), n2 = this.cacheSizeBytes !== void 0 ? $r.withCacheSize(this.cacheSizeBytes) : $r.DEFAULT;
    ...
    return function(t3) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(n2) {
          switch (n2.label) {
            case 0:
              return e = O2(t3), N2("RemoteStore", "RemoteStore shutting down."), e.$r.add(5), [4, Po(e)];
            case 1:
...
var lu = function() {
  function t2(t3, e) {
    var n2 = this;
    this.Go = t3, this.R = e, this.metadata = new vr(), this.buffer = new Uint8Array(), this.zo = new TextDecoder("utf-8"), this.Ho().then(function(t4) {
...
var pu = function() {
  function t2(t3, e, n2, r2) {
    this.asyncQueue = t3, this.datastore = e, this.updateFunction = n2, this.deferred = r2, this.ec = 5, this.Zi = new No(this.asyncQueue, "transaction_retry");
  }
  return t2.prototype.run = function() {
    ...
    if (t3.name === "FirebaseError") {
      var e = t3.code;
      return e === "aborted" || e === "failed-precondition" || !Be(e);
    }
    return false;
  }, t2;
}();
              ...
              return function(t3, e2) {
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(i2) {
                    switch (i2.label) {
                      case 0:
                        return (n4 = O2(t3)).asyncQueue.verifyOperationInProgress(), N2("RemoteStore", "RemoteStore received new credentials"), r3 = jo(n4), n4.$r.add(3), [4, Po(n4)];
                      case 1:
                        return i2.sent(), r3 && n4.Br.set("Unknown"), [4, n4.remoteSyncer.handleCredentialChange(e2)];
                      case 2:
                        return i2.sent(), n4.$r.delete(3), [4, Lo(n4)];
                      case 3:
                        return i2.sent(), [2];
                    }
                  });
            ...
            return r3 = function(t3, e2, n3, r4, i2) {
              var o2 = new fu({
                next: function(o3) {
                  ...
                  !u && o3.fromCache ? i2.reject(new T2(E2.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && o3.fromCache && r4 && r4.source === "server" ? i2.reject(new T2(E2.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i2.resolve(o3);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
            ...
            return r3 = function(t3, e2, n3, r4, i2) {
              var o2 = new fu({
                next: function(n4) {
                  e2.enqueueAndForget(function() {
                    return ds(t3, s);
                  }), n4.fromCache && r4.source === "server" ? i2.reject(new T2(E2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i2.resolve(n4);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
...
var Nu = function(t2, e, n2, r2, i, o, s) {
...
var Cu = function() {
  ...
  return t2.prototype.getToken = function() {
    ...
    this.changeListener = t3, t3(uo.UNAUTHENTICATED);
...
var Ru = function() {
  function t2(t3) {
    var e = this;
    this.oc = null, this.currentUser = uo.UNAUTHENTICATED, this.receivedInitialUser = false, this.cc = 0, this.changeListener = null, this.forceRefresh = false, this.oc = function() {
      ...
      optional: true
    }), this.auth ? this.auth.addAuthTokenListener(this.oc) : (this.oc(null), t3.get().then(function(t4) {
      e.auth = t4, e.oc && e.auth.addAuthTokenListener(e.oc);
    }, function() {
    }));
  }
  return t2.prototype.getToken = function() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(n2).then(function(n3) {
      return t3.cc !== e ? (N2("FirebaseCredentialsProvider", "getToken aborted due to token change."), t3.getToken()) : n3 ? (R2(typeof n3.accessToken == "string"), new xu(n3.accessToken, t3.currentUser)) : null;
    ...
    return R2(t3 === null || typeof t3 == "string"), new uo(t3);
  }, t2;
}();
var Ou = function() {
  function t2(t3, e, n2) {
...
function Uu(t2) {
  ...
  return typeof t2 == "function" ? "a function" : C();
}
function Bu(t2, e) {
...
var Gu = function() {
  ...
  return Object.defineProperty(t2.prototype, "app", {
    ...
    this._settings = new Ku(t3), t3.credentials !== void 0 && (this._credentials = function(t4) {
      if (!t4)
        return new Cu();
      switch (t4.type) {
        case "gapi":
          var e = t4.client;
          return R2(!(typeof e != "object" || e === null || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Lu(e, t4.sessionIndex || "0", t4.iamToken || null);
        case "provider":
          return t4.client;
        default:
...
var Wu = function(t2) {
  function e(e2, n2, r2) {
    var i = this;
    return (i = t2.call(this, e2, n2, Qt(r2)) || this)._path = r2, i.type = "collection", i;
  }
  return __extends(e, t2), Object.defineProperty(e.prototype, "id", {
    ...
    get: function() {
      ...
      return t3.isEmpty() ? null : new Qu(this.firestore, null, new st(t3));
    },
    enumerable: false,
    configurable: true
...
function Hu(t2, e) {
  ...
  if (t2 = getModularInstance(t2), Pu("collection", "path", e), t2 instanceof Gu)
    return qu(n2 = Q2.fromString.apply(Q2, __spreadArray([e], r2))), new Wu(t2, null, n2);
  ...
  return qu(n2 = Q2.fromString.apply(Q2, __spreadArray([t2.path], r2)).child(Q2.fromString(e))), new Wu(t2.firestore, null, n2);
}
function Yu(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
    r2[i - 2] = arguments[i];
  if (t2 = getModularInstance(t2), arguments.length === 1 && (e = P2.u()), Pu("doc", "path", e), t2 instanceof Gu)
    return Vu(n2 = Q2.fromString.apply(Q2, __spreadArray([e], r2))), new Qu(t2, null, new st(n2));
  if (!(t2 instanceof Qu || t2 instanceof Wu))
    throw new T2(E2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
var Ju = function() {
  function t2() {
    var t3 = this;
    this.fc = Promise.resolve(), this.dc = [], this.wc = false, this._c = [], this.mc = null, this.yc = false, this.gc = [], this.Zi = new No(this, "async_queue_retry"), this.Ec = function() {
      var e2 = So();
      e2 && N2("AsyncQueue", "Visibility state changed to " + e2.visibilityState), t3.Zi.Gi();
    };
    var e = So();
    e && typeof e.addEventListener == "function" && e.addEventListener("visibilitychange", this.Ec);
  }
  return Object.defineProperty(t2.prototype, "isShuttingDown", {
    ...
    if (!this.wc) {
      this.wc = true;
      var t3 = So();
      t3 && typeof t3.removeEventListener == "function" && t3.removeEventListener("visibilitychange", this.Ec);
    }
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(n2) {
        switch (n2.label) {
          ...
          case 4:
            this.dc.length > 0 && this.Zi.ji(function() {
              return e.Ac();
            }), n2.label = 5;
          case 5:
            return [2];
    ...
    var e = this, n2 = this.fc.then(function() {
      return e.yc = true, t3().catch(function(t4) {
        throw e.mc = t4, e.yc = false, A2("INTERNAL UNHANDLED ERROR: ", function(t5) {
          var e2 = t5.message || "";
    ...
    var r2 = this;
    this.Tc(), this.gc.indexOf(t3) > -1 && (e = 0);
...
var na2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype._terminate = function() {
    return this._firestoreClient || ia(this), this._firestoreClient.terminate();
  }, e;
}(Gu);
/**
 * @license
    ...
    return __awaiter(r2, void 0, void 0, function() {
      ...
      return __generator(this, function(o) {
        switch (o.label) {
          ...
          case 3:
            if (!function(t3) {
              return t3.name === "FirebaseError" ? t3.code === E2.FAILED_PRECONDITION || t3.code === E2.UNIMPLEMENTED : !(typeof DOMException != "undefined" && t3 instanceof DOMException) || (t3.code === 22 || t3.code === 20 || t3.code === 11);
            }(r3 = o.sent()))
              throw r3;
...
var la = function() {
  ...
  return t2.prototype.toMutation = function(t3, e) {
    return this.fieldMask !== null ? new Re(t3, this.data, this.fieldMask, e, this.fieldTransforms) : new Ce(t3, this.data, e, this.fieldTransforms);
  }, t2;
}();
var da2 = function() {
  function t2(t3, e, n2) {
...
var ya = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.settings = t3, this.databaseId = e, this.R = n2, this.ignoreUndefinedProperties = r2, i === void 0 && this.Sc(), this.fieldTransforms = i || [], this.fieldMask = o || [];
  }
  return Object.defineProperty(t2.prototype, "path", {
    ...
    var e, n2 = (e = this.path) === null || e === void 0 ? void 0 : e.child(t3), r2 = this.Cc({
      path: n2,
      xc: false
    });
    return r2.Fc(t3), r2;
...
var va = function() {
  ...
  return t2.prototype.Bc = function(t3, e, n2, r2) {
    return r2 === void 0 && (r2 = false), new ya({
      Dc: t3,
      methodName: e,
      Lc: n2,
      path: W2.emptyPath(),
...
var wa = function(t2) {
  ...
  return __extends(e, t2), e.prototype._toFieldTransform = function(t3) {
    if (t3.Dc !== 2)
      throw t3.Dc === 1 ? t3.$c(this._methodName + "() can only appear at the top level of your update data") : t3.$c(this._methodName + "() cannot be used with set() unless you pass {merge:true}");
...
var _a = function(t2) {
  ...
  return __extends(e, t2), e.prototype._toFieldTransform = function(t3) {
    var e2 = ba2(this, t3, true), n2 = this.qc.map(function(t4) {
      return Aa2(t4, e2);
    }), r2 = new pe(n2);
...
function Na(t2, e, n2, r2) {
  return r2 === void 0 && (r2 = false), Aa2(n2, t2.Bc(r2 ? 4 : 3, e));
}
function Aa2(t2, e) {
  if (xa(t2 = getModularInstance(t2)))
...
function ka2(t2, e) {
  var n2 = {};
  return K2(t2) ? e.path && e.path.length > 0 && e.fieldMask.push(e.path) : j(t2, function(t3, r2) {
...
function xa(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof q2 || t2 instanceof ha2 || t2 instanceof aa2 || t2 instanceof Qu || t2 instanceof ca2);
}
function Ca2(t2, e, n2) {
  if (!xa(n2) || !function(t3) {
    ...
    var r2 = Uu(n2);
    throw r2 === "an object" ? e.$c(t2 + " a custom object") : e.$c(t2 + " " + r2);
  }
}
function Ra2(t2, e, n2) {
  if ((e = getModularInstance(e)) instanceof ua2)
    return e._internalPath;
  if (typeof e == "string")
    return La2(t2, e);
  throw Pa("Field path arguments must be of type string or FieldPath.", t2, false, void 0, n2);
}
var Oa = new RegExp("[~\\*/\\[\\]]");
function La2(t2, e, n2) {
  if (e.search(Oa) >= 0)
    throw Pa("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t2, false, void 0, n2);
  try {
    return new (ua2.bind.apply(ua2, __spreadArray([void 0], e.split("."))))()._internalPath;
  } catch (r2) {
    throw Pa("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t2, false, void 0, n2);
  }
}
...
var Fa2 = function() {
  ...
  return Object.defineProperty(t2.prototype, "id", {
    ...
    if (this._document) {
      if (this._converter) {
        var t3 = new Va2(this._firestore, this._userDataWriter, this._key, this._document, null);
...
function qa2(t2, e) {
  return typeof e == "string" ? La2(t2, e) : e instanceof ua2 ? e._internalPath : e._delegate._internalPath;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var Ba2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.exists = function() {
    ...
    if (t3 === void 0 && (t3 = {}), this._document) {
      if (this._converter) {
        var e2 = new ja2(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
...
function Qa2(t2, e) {
  return t2 instanceof Ba2 && e instanceof Ba2 ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof Ka2 && e instanceof Ka2 && t2._firestore === e._firestore && $u(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot);
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */
function za2(t2) {
  if (Wt(t2) && t2.explicitOrderBy.length === 0)
  ...
  return __extends(e, t2), e.prototype._apply = function(t3) {
    var e2 = ma2(t3.firestore), n2 = function(t4, e3, n3, r2, i, o, s) {
      ...
      if (i.isKeyField()) {
        ...
        o !== "in" && o !== "not-in" && o !== "array-contains-any" || nc2(s, o), u = Na(n3, "where", s, o === "in" || o === "not-in");
...
var sc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.convertBytes = function(t3) {
    ...
    return new Qu(this.firestore, null, e2);
  }, e;
}(ic2);
var uc2 = function() {
  function t2(t3, e) {
  ...
  return t2.prototype.set = function(t3, e, n2) {
    ...
    var r2 = ac2(t3, this._firestore), i = oc2(r2._converter, e, n2), o = ga(this._dataReader, "WriteBatch.set", r2._key, i, r2._converter !== null, n2);
    ...
    return o = typeof (e = getModularInstance(e)) == "string" || e instanceof ua2 ? Da2(this._dataReader, "WriteBatch.update", s._key, e, n2, r2) : Sa(this._dataReader, "WriteBatch.update", s._key, e), this._mutations.push(o.toMutation(s._key, Ee.exists(true))), this;
  }, t2.prototype.delete = function(t3) {
    this._verifyNotCommitted();
...
function hc2(t2, e, n2) {
  ...
  return lc2(o, [(typeof (e = getModularInstance(e)) == "string" || e instanceof ua2 ? Da2(s, "updateDoc", t2._key, e, n2, r2) : Sa(s, "updateDoc", t2._key, e)).toMutation(t2._key, Ee.exists(true))]);
}
function fc2(t2) {
  ...
  typeof i[a] != "object" || Zu(i[a]) || (s = i[a], a++);
  var c, h2, f, l = {
...
var pc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.get = function(e2) {
    ...
    return t2.prototype.get.call(this, e2).then(function(t3) {
      return new Ba2(n2._firestore, i, r2._key, t3._document, new Ua2(false, false), r2._converter);
    });
  }, e;
}(function() {
  function t2(t3, e) {
  ...
  return t2.prototype.get = function(t3) {
    ...
    var r2 = ac2(t3, this._firestore), i = oc2(r2._converter, e, n2), o = ga(this._dataReader, "Transaction.set", r2._key, i, r2._converter !== null, n2);
    return this._transaction.set(r2._key, o), this;
  }, t2.prototype.update = function(t3, e, n2) {
    for (var r2 = [], i = 3; i < arguments.length; i++)
      r2[i - 3] = arguments[i];
    var o, s = ac2(t3, this._firestore);
    return o = typeof (e = getModularInstance(e)) == "string" || e instanceof ua2 ? Da2(this._dataReader, "Transaction.update", s._key, e, n2, r2) : Sa(this._dataReader, "Transaction.update", s._key, e), this._transaction.update(s._key, o), this;
  }, t2.prototype.delete = function(t3) {
    var e = ac2(t3, this._firestore);
...
var gc2 = function() {
  ...
  return t2.prototype.enableIndexedDbPersistence = function(t3, e) {
    return function(t4, e2) {
      ...
      return oa2(n2, i, new uu(i, r2.cacheSizeBytes, e2 == null ? void 0 : e2.forceOwnership));
    }(t3._delegate, {
      forceOwnership: e
    });
...
var wc2 = function() {
  ...
  return Object.defineProperty(t2.prototype, "_databaseId", {
    ...
    !function(t4, e2, n2) {
      ...
      r2.host !== "firestore.googleapis.com" && r2.host !== e2 && k2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t4._setSettings(Object.assign(Object.assign({}, r2), {
        host: e2 + ":" + n2,
        ssl: false
      }));
    }(this._delegate, t3, e);
                ...
                return n2 = r2.sent(), [2, (e2.setNetworkEnabled(false), function(t4) {
                  return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(n3) {
                      switch (n3.label) {
                        case 0:
                          return (e3 = O2(t4)).$r.add(0), [4, Po(e3)];
                        case 1:
    ...
    try {
      return new Cc2(this, function(t4, e) {
        ...
        return new zu(t4, null, function(t5) {
          ...
          return __awaiter(n2, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              switch (i.label) {
                ...
                case 1:
                  return n3 = i.sent(), new pu(t5.asyncQueue, n3, e3, r2).run(), [2];
              }
            });
          });
        }), r2.promise;
...
var bc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.convertBytes = function(t3) {
    ...
    var e2 = this.convertDocumentKey(t3, this.firestore._databaseId);
    return Sc2.Zc(e2, this.firestore, null);
  }, e;
}(ic2);
function Ic2(t2) {
  var e;
...
var Tc2 = function() {
  ...
  return t2.prototype.fromFirestore = function(t3, e) {
    var n2 = new ja2(this._firestore._delegate, this._userDataWriter, t3._key, t3._document, t3.metadata, null);
    return this._delegate.fromFirestore(new xc(this._firestore, n2), e != null ? e : {});
  ...
  return t2.nu = function(e, n2, r2) {
    ...
    try {
      return function(t4, e2, n2) {
        ...
        return lc2(r2, [ga(ma2(r2), "setDoc", t4._key, i, t4._converter !== null, n2).toMutation(t4._key, Ee.none())]);
      }(this._delegate, t3, e);
    } catch (t4) {
    ...
    try {
      return arguments.length === 1 ? hc2(this._delegate, t3) : hc2.apply(void 0, __spreadArray([this._delegate, t3, e], n2));
    } catch (t4) {
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
      ...
      return function(t5, e3) {
        ...
        return new Ba2(e2, r2, t4._key, n3, new Ua2(n3 !== null && n3.hasLocalMutations, true), t4._converter);
      });
...
function Ac2(t2, e) {
  ...
  return {
    ...
    error: (n2 = (i = Zu(t2[0]) ? t2[0] : Zu(t2[1]) ? t2[1] : typeof t2[0] == "function" ? {
      next: t2[0],
      error: t2[1],
      complete: t2[2]
    } : {
  ...
  return t2.prototype.where = function(e, n2, r2) {
    ...
    try {
      return new t2(this.firestore, Ha2(this._delegate, function(t3) {
        return ju("limit", t3), new $a2("limit", t3, "F");
      }(e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Ha2(this._delegate, function(t3) {
        return ju("limitToLast", t3), new $a2("limitToLast", t3, "L");
      }(e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Ha2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new Ja2("startAt", t3, true);
      }.apply(void 0, e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Ha2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new Ja2("startAfter", t3, false);
      }.apply(void 0, e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Ha2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new Za2("endBefore", t3, true);
      }.apply(void 0, e)));
    } catch (e2) {
                  ...
                  return n4 = function(t6, e4, n5) {
                    return __awaiter(this, void 0, void 0, function() {
                      ...
                      return __generator(this, function(a) {
                        switch (a.label) {
                          case 0:
                            return a.trys.push([0, 2, , 3]), [4, Qi(t6, e4, true)];
                          case 1:
                            return u = a.sent(), r4 = new Ts(e4, u.Bn), i2 = r4._o(u.documents), o = r4.applyChanges(i2, false), n5.resolve(o.snapshot), [3, 3];
                          case 2:
...
var Lc2 = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "id", {
    ...
    try {
      return new Sc2(this.firestore, t3 === void 0 ? Yu(this._delegate) : Yu(this._delegate, t3));
    } catch (t4) {
    ...
    return function(t4, e3) {
      ...
      return lc2(n2, [ga(ma2(t4.firestore), "addDoc", r2._key, i, t4._converter !== null, {}).toMutation(r2._key, Ee.exists(false))]).then(function() {
        return r2;
      });
